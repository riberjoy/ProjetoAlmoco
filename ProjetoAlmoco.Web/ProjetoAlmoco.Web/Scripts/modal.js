...
function insModal(tipoOperacao, caminho, campo) {
    ...
    $("<input>", { class: "admnCadCategoria__link", type: "submit", value: campo }).appendTo("body div.modal div.modal-content form.formCategoria");
